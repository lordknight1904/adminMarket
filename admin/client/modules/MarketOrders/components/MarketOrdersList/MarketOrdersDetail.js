...
class MarketOrdersDetail extends Component {
  constructor(props) {
    super(props);
    this.state = {
      time: new Date(),
  ...
  render() {
    ...
    return (
      <tr>
        ...
        <th>{numeral((detail.amount - detail.feeNetwork - detail.feeTrade) / unit).format('0,0.[000000]')}</th>
...
MarketOrdersDetail.contextTypes = {
  router: PropTypes.object,
};

export default connect(mapStateToProps)(MarketOrdersDetail);
